...
# ====== 数据集路径 ======
SOURCE_PATH="/home/martin/code/dp-gs/data/mip-nerf/360_v2/treehill"
MODEL_PATH="/home/martin/code/dp-gs/outputs/mip-nerf/360_v2/treehill"
mkdir -p ${MODEL_PATH}
